...
public class TreeUniverse implements UniverseInterface {
   ...
   public void setBit(int x, int y) {
	   System.out.println("Bit set: " + x + "  " + y + "  ");
      /*
   ...
   public String stats() {
      return "Generation " + nf.format(generationCount) +
             ...
             + "\n Output:\n" + root.getBit(0, 0)+
             root.getBit(1, 0)+root.getBit(2, 0) + "\n"
             +root.getBit(0, 1)+root.getBit(1, 1)+root.getBit(2, 1)+"\n"
             +root.getBit(0, 2)+root.getBit(1, 2)+root.getBit(2, 2) +"\n"
             +root.getBit(-100000000, 2)
             ;
   }
   /*
    *   The data we use.
